...
#include "full_name_message/srv/detail/full_name__rosidl_typesupport_fastrtps_c.h"
...
using _FullName_Request__ros_msg_type = full_name_message__srv__FullName_Request;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = full_name_message__srv__FullName_Request;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const full_name_message__srv__FullName_Request * ros_message = static_cast<const full_name_message__srv__FullName_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_full_name_message__srv__FullName_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  full_name_message__srv__FullName_Request * ros_message = static_cast<full_name_message__srv__FullName_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_full_name_message__srv__FullName_Request(cdr, ros_message);
}

static uint32_t _FullName_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_full_name_message__srv__FullName_Request(
...
static size_t _FullName_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_full_name_message__srv__FullName_Request(
...
using _FullName_Response__ros_msg_type = full_name_message__srv__FullName_Response;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = full_name_message__srv__FullName_Response;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const full_name_message__srv__FullName_Response * ros_message = static_cast<const full_name_message__srv__FullName_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_full_name_message__srv__FullName_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  full_name_message__srv__FullName_Response * ros_message = static_cast<full_name_message__srv__FullName_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_full_name_message__srv__FullName_Response(cdr, ros_message);
}

static uint32_t _FullName_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_full_name_message__srv__FullName_Response(
      untyped_ros_message, 0));
}
...
static size_t _FullName_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_full_name_message__srv__FullName_Response(
    full_bounded, is_plain, 0);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_full_name_message
...
using _FullName_Event__ros_msg_type = full_name_message__srv__FullName_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_full_name_message__srv__FullName_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_full_name_message__srv__FullName_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  full_name_message__srv__FullName_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      full_name_message__srv__FullName_Request__Sequence__fini(&ros_message->request);
    }
    if (!full_name_message__srv__FullName_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_full_name_message__srv__FullName_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      full_name_message__srv__FullName_Response__Sequence__fini(&ros_message->response);
    }
    if (!full_name_message__srv__FullName_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_full_name_message__srv__FullName_Response(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_full_name_message__srv__FullName_Event(
  ...
  size_t current_alignment)
{
  const _FullName_Event__ros_msg_type * ros_message = static_cast<const _FullName_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_full_name_message__srv__FullName_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_full_name_message__srv__FullName_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_full_name_message__srv__FullName_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_full_name_message__srv__FullName_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = full_name_message__srv__FullName_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_full_name_message__srv__FullName_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_full_name_message__srv__FullName_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_full_name_message__srv__FullName_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_full_name_message__srv__FullName_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_full_name_message__srv__FullName_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_full_name_message__srv__FullName_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const full_name_message__srv__FullName_Event * ros_message = static_cast<const full_name_message__srv__FullName_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_full_name_message__srv__FullName_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  full_name_message__srv__FullName_Event * ros_message = static_cast<full_name_message__srv__FullName_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_full_name_message__srv__FullName_Event(cdr, ros_message);
}

static uint32_t _FullName_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_full_name_message__srv__FullName_Event(
      untyped_ros_message, 0));
}
...
static size_t _FullName_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_full_name_message__srv__FullName_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_FullName_Event = {
  "full_name_message::srv",
  "FullName_Event",
...
static rosidl_message_type_support_t _FullName_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FullName_Event,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_message, srv, FullName_Event)() {
  return &_FullName_Event__type_support;
}
...
static rosidl_service_type_support_t FullName__handle = {
  ...
  &_FullName_Request__type_support,
  &_FullName_Response__type_support,
  &_FullName_Event__type_support,
