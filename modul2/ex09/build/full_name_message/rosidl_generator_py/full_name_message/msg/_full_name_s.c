...
bool full_name_message__msg__full_name__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("full_name_message.msg._full_name", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("FullName", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  full_name_message__msg__FullName * ros_message = _ros_message;
  {  // last_name
...
{
  /* NOTE(esteve): Call constructor of FullName */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("full_name_message.msg._full_name");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FullName");
