...
def generate_launch_description():
    ...
    # Пути к файлам - теперь указываем на XACRO файл
    ...
    # Узел публикации состояния соединений (без GUI)
    ...
    # Узел публикации состояния соединений (с GUI)
    ...
    return LaunchDescription([
        ...
        # Аргумент для пути к модели робота (теперь XACRO)
        DeclareLaunchArgument(
            name='model', 
        ...
        # Аргумент для пути к конфигурации RViz
        DeclareLaunchArgument(
            name='rvizconfig', 
